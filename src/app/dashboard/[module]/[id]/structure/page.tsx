...
export default async function CourseStructurePage({ params }: Props) {
  ...
  if (module !== "courses") {
    if (module === "learning") {
      redirect(`/dashboard/courses/${courseId}/structure`);
    }
    redirect(`/dashboard/${module}/${courseId}`);
  }
        ...
        <section className="brand-glass brand-animate p-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="brand-muted mt-2 text-sm">Configure course structure, release rules, and lessons.</p>
            </div>
            <Link
