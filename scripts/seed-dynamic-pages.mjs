...
const govtSections = [
  ...
  },
  {
    ...
    position: 1,
    content: { sourceLanguage: 'en', translations: { en: { discountPercent: 25, contactEmail: 'govtservices@staustin.edu', phoneNumber: '' }, fr: { discountPercent: 25, contactEmail: 'govtservices@staustin.edu', phoneNumber: '' } } },
  },
  {
